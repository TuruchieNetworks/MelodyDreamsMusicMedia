...
export default function Profilepage(props) {
  ...
  const vectorTwoNineSevenSixSixSevenSixEightOnClick = useNavigateAction({
    anchor: "",
    type: "anchor",
  });
  return (
        ...
        >
          ...
          >
            <Icon
              ...
              right="41.67%"
              onClick={() => {
                vectorTwoNineSevenSixSixSevenSixEightOnClick();
              }}
